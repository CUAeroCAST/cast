function [burnTime,tAfter,stateAfter,a] = lookup_burn_time(estimate,satelliteState,direction,timeToCol,burnTimesteps,burnTable,positionTable,timeTable)
...
for i = 1:30
    ...
    if (maneuverPos(1)>xminCart(1) && maneuverPos(1)<xmaxCart(1)) && (maneuverPos(2)>yminCart(2) && maneuverPos(2)<ymaxCart(2))
        ...
        stateAfter = burnTable{i,directionIndex};
        tAfter = timeTable{i,directionIndex};
        a = 0;
        break
    end
end
